...
CREATE INDEX IF NOT EXISTS platform_administrators_status_idx
  ON platform_administrators (status, updated_at DESC);

CREATE INDEX IF NOT EXISTS platform_administrators_identity_idx
  ON platform_administrators (identity_issuer, identity_subject);
